...
![Clear](https://docs-assets.developer.apple.com/published/a3f01b0f1606a38618e47d4e5f7a01d6/media-3546413%402x.png)

### Copy
Replaces the background with the source image entirely, ignoring the background's existing pixels.
![Copy](https://docs-assets.developer.apple.com/published/a523a1a9e9a4051a8f94602f23b7b25e/media-3546409%402x.png)

### Source Over
Draws the source image on top of the background. The default blending mode.
![Source Over](https://docs-assets.developer.apple.com/published/6290d2e8b0124b8988e0b6df423f7d1b/media-3546408%402x.png)

### Source Atop
Composites the source image atop the background, only displaying where they overlap.
![Source Atop](https://docs-assets.developer.apple.com/published/2b1f81d1136d8d9f10a699a27c1340b9/media-3546395%402x.png)
...
![Destination In](https://docs-assets.developer.apple.com/published/bb1b8273617304192b00ff3d52601700/media-3546400%402x.png)

### Destination Out
Shows the background only where the source is transparent. The source cuts a hole in the background.
![Destination Out](https://docs-assets.developer.apple.com/published/3d1c4794e2264ee161ce38f61559e2a3/media-3546405%402x.png)

### Destination Atop
Composites the background atop the source, only displaying where they overlap.
![Destination Atop](https://docs-assets.developer.apple.com/published/617c0b05b38ed6c06a337f9e8557e0e7/media-3546402%402x.png)

### Xor
Combines source and background, with overlapping areas becoming transparent. Useful for reversible selections.
![Xor](https://docs-assets.developer.apple.com/published/0ff01d29381504945118f6c382103f16/media-3546417%402x.png)

### Plus Darker
Adds the source and background pixel values, resulting in a darker combined image.
![Plus Darker](https://docs-assets.developer.apple.com/published/77c9803d3683697a216e91f16ed87a55/media-3546408%402x.png)

### Plus Lighter (or Add)
Brightens the image by adding the source and background pixel values, useful for highlights and light effects.
![Plus Lighter](https://docs-assets.developer.apple.com/published/850255fdcb98366a0fe7ffc82ce931b1/media-3546408%402x.png)
...
### Source Atop
Composites the source image atop the background, only displaying where they overlap.
![Source Atop](https://docs-assets.developer.developer.apple.com/published/2b1f81d1136d8d9f10a699a27c1340b9/media-3546395%402x.png)
